...
Instance mappings are shown in Table~\ref{tbl:example-chain-1-mapping} and Table~\ref{tbl:example-chain-2-mapping}.
Also link mappings are shown in Table~\ref{tbl:example-chain-1-links} and Table~\ref{tbl:example-chain-2-links}.
...
\begin{table}
    \centering
    \caption{Chain-2 Instance Mapping of illustrative example}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
