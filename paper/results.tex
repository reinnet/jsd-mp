...
3--4 nodes attached to each of its points. Each point is the average of 10--15
CPLEX runs under a time limit and a 5\% optimality-gap limit.
...
capacity over two orders of magnitude does not move the gap at all
...
constant at 16.7~pp from capacity 1 to 100.}
